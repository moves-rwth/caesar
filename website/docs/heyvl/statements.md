...
This choice can be made explicit with the [calculus annotations](../proof-rules/approximations.md#calculus-annotations) on procedures, which we recommend you use.
