...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{
      \step[fieldsource=url, match=\regexp{\\_}, replace=_]
    }
    \map{
      \step[fieldsource=doi, match=\regexp{\\_}, replace=_]
    }
  }
}
...
\titlerunning{Diagnostics for Probabilistic Program Verification}
...
\ifAnon{
	...
	\author{Philipp Schröer\inst{1}\orcidID{0000-0002-4329-530X} \and
		Darion Haase\inst{1}\orcidID{0000-0001-5664-6773} \and
		Joost-Pieter Katoen\inst{1}\orcidID{0000-0002-6143-1926}
	}%
	\authorrunning{P. Schröer et al.}
	\institute{RWTH Aachen University, Germany \\
		\email{\{phisch, darion.haase, katoen\}@cs.rwth-aachen.de}}
}
