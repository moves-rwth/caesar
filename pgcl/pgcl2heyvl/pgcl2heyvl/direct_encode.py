...
def direct_encode_k_ind(program: Program, post: Expr, pre: Expr, calculus: Calculus,
...
def direct_encode_bounded_mc(program: Program, post: Expr, pre: Expr,
                      calculus: Calculus,
                      loop_annotations: List[Tuple[int, Expr]]) -> HeyObjects:
    """
...
def direct_encode_ast_mciver(program: Program, invariant: Expr, variant: Expr,
...
def direct_encode_past(program: Program, invariant: Expr, eps: Expr,
                k: Expr) -> HeyObjects:
    """
...
def direct_encode_optional_stopping(program: Program, post: Expr, invariant: Expr,
...
def direct_encode_omega_inv(program: Program, calculus: Calculus, invariant: Expr,
